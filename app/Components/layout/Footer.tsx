    ...
    <footer className="bg-[#0E0E0E] w-full border-t border-primary/20 z-10 relative">
      <div className="max-w-[1920px] mx-auto flex flex-col md:flex-row justify-between items-center px-10 py-12 gap-8">
        ...
        <div className="flex items-center gap-4">
          <span className="text-primary font-bold text-lg font-display tracking-tight uppercase">
            TEAM ARION
          </span>
          <div className="h-4 w-[1px] bg-outline-variant/40"></div>
          <p className="text-white/40 font-body text-[10px] uppercase tracking-[0.1em]">
            © {year} TEAM ARION. ALL RIGHTS RESERVED.
          </p>
        </div>
        ...
        <div className="flex gap-10 items-center">
          <Link
            className="font-body text-[10px] uppercase tracking-[0.1em] text-white/40 hover:text-primary transition-colors duration-200"
            href="/contact"
          >
            CONTACT US
          </Link>
