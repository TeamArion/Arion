...
export const metadata: Metadata = {
  ...
  description: 'A collective of precision-driven engineers and creative strategists.',
};
  ...
  return (
    <div className="bg-[#0d1514] text-[#dce4e2] font-body selection:bg-[#0beae0] selection:text-[#006560] min-h-screen relative overflow-hidden">
      ...
      <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full text-center z-0 pointer-events-none select-none opacity-[0.03]">
        <h1 className="font-display text-[15vw] md:text-[20vw] font-black uppercase tracking-tighter leading-none text-white whitespace-nowrap">
          ENGINEERS OF SPEED
        </h1>
      </div>
      ...
      <main className="pt-32 pb-20 relative z-10">
        ...
        <section className="max-w-7xl mx-auto px-8 mb-24">
          ...
          <div className="flex justify-between items-end border-t border-[#3b4a48] pt-6">
            <p className="max-w-xl text-[#c6c6c7] font-light text-lg">
              A collective of precision-driven engineers and creative strategists pushing the boundaries of Formula Student competition. Every member is a critical component of the Arion legacy.
            </p>
