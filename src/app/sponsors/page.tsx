...
export default function SponsorsPage() {
  return (
    <main className="min-h-screen bg-[#08100f] text-[#e5e2e1] selection:bg-[#0BEAE0] selection:text-[#fff9f8] pt-24 font-body">
      
      {/* Hero Header Section */}
      <section className="relative px-6 py-20 border-b border-[#2a2a2a] overflow-hidden">
        {/* Kinetic Tech Background */}
        <div className="absolute inset-0 z-0 opacity-20">
          <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-[#08100f] z-10"></div>
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_2px_2px,rgba(11,234,224,0.15)_1px,transparent_0)] bg-[length:40px_40px]"></div>
        </div>
        ...
        <div className="relative z-10 max-w-[1920px] mx-auto flex flex-col items-start gap-6">
          <h1 className="font-display font-black text-6xl md:text-8xl uppercase tracking-tighter text-white">
            Partners in <span className="text-[#0BEAE0]">Speed</span>
          </h1>
