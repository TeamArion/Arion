    ...
    if (sponsors && sponsors.length > 0) {
      ...
      if (dbSponsor) {
        sponsor = {
          ...
          slug: getSlug(dbSponsor.name),
          logo: dbSponsor.logo_url,
          tier: dbSponsor.tier === "TITLE" ? "Platinum" as const : "Gold" as const,
          description: dbSponsor.description || "Driving the future of electric mobility with Team Arion Racing.",
